...
- [terraform-aws-eks-base](https://github.com/maddevsio/aws-eks-base) - Create Kubernetes Cluster, Supporting Services, and the Underlying Infrastructure in the Amazon Cloud (alternative module).
